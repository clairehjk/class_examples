...
oscarLogits <- augment(boxOfficeModel, filmData)
...
#mod_plot(fullModel)
model <- augment(fullModel, filmData)
binnedplot(model$.fitted ,model$.resid,
    xlab="Expected Values11", ylab="Average residual", 
    main="Binned residual plot", 
    cex.pts=0.8, col.pts=1, col.int="gray")
